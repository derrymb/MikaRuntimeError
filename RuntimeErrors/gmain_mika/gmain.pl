...
procedure_body(
  Foo_367, no_return,
  parameters([param([A_368, B_369], in_out, subtype_indication(may_be_null,Integer_4, no_constraint), no_init)])
))])
, no_private
                     )
,
...
procedure_body(
  ...
  parameters([param([A_368, B_369], in_out, subtype_indication(may_be_null,Integer_4, no_constraint), no_init)])
,
  local_decl([  object(not_qualified, [X_370], subtype_indication(may_be_null,Integer_4, no_constraint), 1),
   object(not_qualified, [Y_371], subtype_indication(may_be_null,Integer_4, no_constraint), 0)
            ]),body(
stmts([
              if_stmt([if_clause(bran(1, deci(1, cond(1, A_368 <> 0))),
              stmts([
              assign(Y_371, 3 + X_370)
                   ]))], 
              else(stmts([]))),
              if_stmt([if_clause(bran(2, deci(2, cond(2, B_369 = 0))),
              stmts([
              assign(X_370, 2 * (A_368 + B_369))
                   ]))], 
              else(stmts([]))),
              assign(A_368, 100 / (X_370 - Y_371))
      ]),
  no_exceptions)
...
procedure_body(
  ...
  parameters([])
,
  local_decl([  object(not_qualified, [A_372], subtype_indication(may_be_null,Integer_4, no_constraint), 2),
   object(not_qualified, [B_373], subtype_indication(may_be_null,Integer_4, no_constraint), 0)
            ]),body(
stmts([
              procedure_call(indexed(Foo_367, [A_372, B_373]))
      ]),
  no_exceptions)
...
stmts([
              procedure_call(selected(Example_364, Bar_365))
      ]),
  no_exceptions)
...
,
mika_ref([
a(A_372, 'example.adb:16:9:a'),
a(B_373, 'example.adb:17:9:b'),
a(X_370, 'example.adb:3:9:x'),
a(Y_371, 'example.adb:4:9:y'),
a(Example_364, 'example.ads:1:9:example'),
a(Bar_365, 'example.ads:2:14:bar'),
a(Foo_367, 'example.ads:3:14:foo'),
a(A_368, 'example.ads:3:18:a'),
a(B_369, 'example.ads:3:22:b'),
a(Gmain_366, 'gmain.adb:2:11:gmain'),
...
target_dir('C:/Ada test code/Runtime errors/gmain_mika/').
...
rune(1, 'example', 'example', '.adb', 'C:\Ada test code\Runtime errors', 17759232, 17759242).
