...
package_specification(
 ...
 local_decl([  object(constant, 
  ...
  object(constant, [Soh_ascii_276], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(2, 1 > tic(tic(Character_15, val), last) || 1 < tic(tic(Character_15, val), first) ,1)])),
  object(constant, [Stx_ascii_277], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(3, 2 > tic(tic(Character_15, val), last) || 2 < tic(tic(Character_15, val), first) ,2)])),
  object(constant, [Etx_ascii_278], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(4, 3 > tic(tic(Character_15, val), last) || 3 < tic(tic(Character_15, val), first) ,3)])),
  object(constant, [Eot_ascii_279], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(5, 4 > tic(tic(Character_15, val), last) || 4 < tic(tic(Character_15, val), first) ,4)])),
  object(constant, [Enq_ascii_280], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(6, 5 > tic(tic(Character_15, val), last) || 5 < tic(tic(Character_15, val), first) ,5)])),
  object(constant, [Ack_ascii_281], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(7, 6 > tic(tic(Character_15, val), last) || 6 < tic(tic(Character_15, val), first) ,6)])),
  object(constant, [Bel_ascii_282], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(8, 7 > tic(tic(Character_15, val), last) || 7 < tic(tic(Character_15, val), first) ,7)])),
  object(constant, [Bs_ascii_283], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(9, 8 > tic(tic(Character_15, val), last) || 8 < tic(tic(Character_15, val), first) ,8)])),
  object(constant, [Ht_ascii_284], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(10, 9 > tic(tic(Character_15, val), last) || 9 < tic(tic(Character_15, val), first) ,9)])),
  object(constant, [Lf_ascii_285], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(11, 10 > tic(tic(Character_15, val), last) || 10 < tic(tic(Character_15, val), first) ,10)])),
  object(constant, [Vt_ascii_286], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(12, 11 > tic(tic(Character_15, val), last) || 11 < tic(tic(Character_15, val), first) ,11)])),
  object(constant, [Ff_ascii_287], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(13, 12 > tic(tic(Character_15, val), last) || 12 < tic(tic(Character_15, val), first) ,12)])),
  object(constant, [Cr_ascii_288], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(14, 13 > tic(tic(Character_15, val), last) || 13 < tic(tic(Character_15, val), first) ,13)])),
  object(constant, [So_ascii_289], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(15, 14 > tic(tic(Character_15, val), last) || 14 < tic(tic(Character_15, val), first) ,14)])),
  object(constant, [Si_ascii_290], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(16, 15 > tic(tic(Character_15, val), last) || 15 < tic(tic(Character_15, val), first) ,15)])),
  object(constant, [Dle_ascii_291], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(17, 16 > tic(tic(Character_15, val), last) || 16 < tic(tic(Character_15, val), first) ,16)])),
  object(constant, [Dc1_ascii_292], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(18, 17 > tic(tic(Character_15, val), last) || 17 < tic(tic(Character_15, val), first) ,17)])),
  object(constant, [Dc2_ascii_293], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(19, 18 > tic(tic(Character_15, val), last) || 18 < tic(tic(Character_15, val), first) ,18)])),
  object(constant, [Dc3_ascii_294], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(20, 19 > tic(tic(Character_15, val), last) || 19 < tic(tic(Character_15, val), first) ,19)])),
  object(constant, [Dc4_ascii_295], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(21, 20 > tic(tic(Character_15, val), last) || 20 < tic(tic(Character_15, val), first) ,20)])),
  object(constant, [Nak_ascii_296], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(22, 21 > tic(tic(Character_15, val), last) || 21 < tic(tic(Character_15, val), first) ,21)])),
  object(constant, [Syn_ascii_297], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(23, 22 > tic(tic(Character_15, val), last) || 22 < tic(tic(Character_15, val), first) ,22)])),
  object(constant, [Etb_ascii_298], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(24, 23 > tic(tic(Character_15, val), last) || 23 < tic(tic(Character_15, val), first) ,23)])),
  object(constant, [Can_ascii_299], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(25, 24 > tic(tic(Character_15, val), last) || 24 < tic(tic(Character_15, val), first) ,24)])),
  object(constant, [Em_ascii_300], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(26, 25 > tic(tic(Character_15, val), last) || 25 < tic(tic(Character_15, val), first) ,25)])),
  object(constant, [Sub_ascii_301], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(27, 26 > tic(tic(Character_15, val), last) || 26 < tic(tic(Character_15, val), first) ,26)])),
  object(constant, [Esc_ascii_302], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(28, 27 > tic(tic(Character_15, val), last) || 27 < tic(tic(Character_15, val), first) ,27)])),
  object(constant, [Fs_ascii_303], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(29, 28 > tic(tic(Character_15, val), last) || 28 < tic(tic(Character_15, val), first) ,28)])),
  object(constant, [Gs_ascii_304], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(30, 29 > tic(tic(Character_15, val), last) || 29 < tic(tic(Character_15, val), first) ,29)])),
  object(constant, [Rs_ascii_305], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(31, 30 > tic(tic(Character_15, val), last) || 30 < tic(tic(Character_15, val), first) ,30)])),
  object(constant, [Us_ascii_306], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(32, 31 > tic(tic(Character_15, val), last) || 31 < tic(tic(Character_15, val), first) ,31)])),
  object(constant, [Del_ascii_307], subtype_indication(may_be_null,Character_15, no_constraint), indexed(tic(Character_15, val), [rune(33, 127 > tic(tic(Character_15, val), last) || 127 < tic(tic(Character_15, val), first) ,127)])),
...
procedure_body(
  ...
  parameters([])
,
  local_decl([ type(Custom_int_365, no_discriminant, new(derived_type_definition(not_limited_nor_synchronized, subtype_indication(may_be_null,Integer_4, constraint(range([0, 50])))))),
  type(Index_366, no_discriminant, integer, Integer_4, range([1, 10])),
  type(Custom_int_array_367, no_discriminant, array, [subtype_indication(may_be_null,Index_366, no_constraint)], component_definition(not_aliased, subtype_indication(may_be_null,Custom_int_365, no_constraint))),
   object(not_qualified, [Array1_368], subtype_indication(may_be_null,Custom_int_array_367, no_constraint), agg([1,
2,
3,
4,
5,
...
9,
10])),
   object(not_qualified, [X_369], subtype_indication(may_be_null,Custom_int_365, no_constraint), 4),
   object(not_qualified, [Y_370], subtype_indication(may_be_null,Custom_int_365, no_constraint), 1),
   object(not_qualified, [W_371], subtype_indication(may_be_null,Index_366, no_constraint), 2),
   object(not_qualified, [R_372], subtype_indication(may_be_null,Index_366, no_constraint), 4),
   object(not_qualified, [T_373], subtype_indication(may_be_null,Custom_int_365, no_constraint), 42)
            ]),body(
stmts([
...
,
mika_ref([
a(W_371, 'constraint.adb:10:5:w'),
a(R_372, 'constraint.adb:11:5:r'),
a(T_373, 'constraint.adb:12:5:t'),
a(Custom_int_365, 'constraint.adb:3:10:custom_int'),
a(Index_366, 'constraint.adb:4:10:index'),
a(Custom_int_array_367, 'constraint.adb:6:10:custom_int_array'),
a(Array1_368, 'constraint.adb:7:5:array1'),
a(X_369, 'constraint.adb:8:5:x'),
a(Y_370, 'constraint.adb:9:5:y'),
a(Constraint_364, 'constraint.ads:1:11:constraint'),
...
target_dir('C:/Users/derry/Documents/GitHub/MikaRuntimeError/RuntimeErrors/constraint_mika/').
...
rune(1, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 114, 65).
rune(2, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 115, 65).
rune(3, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 116, 65).
rune(4, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 117, 65).
rune(5, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 118, 65).
rune(6, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 119, 65).
rune(7, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 120, 65).
rune(8, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 121, 65).
rune(9, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 122, 65).
rune(10, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 123, 65).
rune(11, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 124, 65).
rune(12, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 125, 65).
rune(13, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 126, 65).
rune(14, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 127, 65).
rune(15, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 128, 65).
rune(16, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 129, 65).
rune(17, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 130, 65).
rune(18, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 131, 65).
rune(19, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 132, 65).
rune(20, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 133, 65).
rune(21, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 134, 65).
rune(22, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 135, 65).
rune(23, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 136, 65).
rune(24, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 137, 65).
rune(25, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 138, 65).
rune(26, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 139, 65).
rune(27, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 140, 65).
rune(28, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 141, 65).
rune(29, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 142, 65).
rune(30, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 143, 65).
rune(31, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 144, 65).
rune(32, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 145, 65).
rune(33, 'standard', 'standard', '.ads', 'C:\Users\derry\AppData\Roaming\Midoan\Mika\bin\..\resources', 146, 65).
cond(1, 'constraint', 'constraint', '.adb', 'C:\Users\derry\Documents\GitHub\MikaRuntimeError\RuntimeErrors', 14, 11).
bran(1, 'constraint', 'constraint', '.adb', 'C:\Users\derry\Documents\GitHub\MikaRuntimeError\RuntimeErrors', 14, 7).
deci(1, 'constraint', 'constraint', '.adb', 'C:\Users\derry\Documents\GitHub\MikaRuntimeError\RuntimeErrors', 14, 7).
rune(34, 'constraint', 'constraint', '.adb', 'C:\Users\derry\Documents\GitHub\MikaRuntimeError\RuntimeErrors', 17, 15).
